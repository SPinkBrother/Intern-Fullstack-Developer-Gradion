...
const store = new JsonStore(resolve(process.env.DATA_DIR || "data"), resolve(process.env.BOOKS_DIR || "storage/books"), resolve(process.env.PORTRAITS_DIR || "storage/portraits"));
await store.init();
